defmodule {{cookiecutter.project_module}}.Mixfile do
  use Mix.Project

  @version "0.0.1"
  @source_url "{{cookiecutter.repo_url}}"
  @description "{{cookiecutter.project_description}}"

  def project do
    [
      app: :{{cookiecutter.project_underscored}},
      version: @version,
      elixir: "~> 1.5",
      ...
      package: [
        ...
        maintainers: ["{{cookiecutter.maintainer_name}}"],
        licenses: ["Apache 2.0"],
